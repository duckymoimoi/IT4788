...
type MedicalRepository interface {
	GetTreatmentsByUserID(userID uint, status []string) ([]schema.Treatment, error)
	GetQueueByPOI(poiID uint) (schema.Queue, error)
	UpdateTreatmentStatus(tx *gorm.DB, treatmentID uint, userID uint, status string) error
	UpdateQueueCount(tx *gorm.DB, poiID uint, delta int) error
...
func (r *medicalRepository) GetTreatmentsByUserID(userID uint, status []string) ([]schema.Treatment, error) {
...
func (r *medicalRepository) GetQueueByPOI(poiID uint) (schema.Queue, error) {
...
func (r *medicalRepository) UpdateTreatmentStatus(tx *gorm.DB, treatmentID uint, userID uint, status string) error {
...
func (r *medicalRepository) UpdateQueueCount(tx *gorm.DB, poiID uint, delta int) error {
